...
\begin{align}
    a_{\mathrm{signed}} &= (-1)^s \left( a_{N-m-2} \times 2^{N-m-2} + a_{N-m-3} \times 2^{N-m-3} + \cdots + a_{1} \times + 2^{1} a_{0} \times 2^{0} \right. \\
...
\begin{table}[H]
    ...
    \begin{tabular}{c|c|c|c}   
        ...
        \begin{tabular}{c}
            $\sum_{i=927}^{1024}2^i$ \\
            $\backsimeq 1.7976931\times 10^{308}$
        \end{tabular}&
        \begin{tabular}{c}
            $-\sum_{i=927}^{1024}2^i$ \\
            $\backsimeq -1.7976931\times 10^{308}$
        ...
        \begin{tabular}{c}
            $2^{-1023}$ \\
            $\backsimeq 2.2250739\times 10^{-308}$
        \end{tabular}
    \end{tabular}

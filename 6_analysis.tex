...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{Euler法を用いて更新幅を$\Delta t = 2^{-7}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{Euler法を用いて更新幅を$\Delta t =  2^{-13}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{4段4次陽的Runge-Kutta法を用いて更新幅を$\Delta t = 2^{-7}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{4段4次陽的Runge-Kutta法を用いて更新幅を$\Delta t =  2^{-13}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{St\"ormer-Verlet法を用いて更新幅を$\Delta t = 2^{-7}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        ...
        \caption{St\"ormer-Verlet法を用いて更新幅を$\Delta t =  2^{-13}$とした場合の異なる数値型(Float64,Q11f52,Q3f60)を用いて数値計算をしたときの数値解により求めた保存量と正確な保存量との誤差}

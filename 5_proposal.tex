...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \node[text=red] (A-3) at (-3,0) {$\bigtriangleup$};
        ...
        \node[text=red] (A2) at (2,0) {$\bigtriangleup$};
        \node[text=red] (A3) at (3,0) {$\bigtriangleup$};
        \draw [->, thick] (-7,0) -- (7,0);
        \node[left] (X) at (8,0) {$x$};
        \node[text=blue] (B0) at (0,0) {$\square$};
        \node[text=blue] (B1) at (1.5,0) {$\square$};
        \node[text=blue] (B2) at (3,0) {$\square$};
